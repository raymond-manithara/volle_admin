...
const AboutproductPage: React.FC = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-syncopate items-center justify-start mx-auto pb-[266px] w-full">
        ...
        <div className="flex flex-col font-worksans items-start justify-start max-w-[1116px] mt-1 mx-auto md:px-5 w-full">
          <div className="flex md:flex-col flex-row gap-[18px] items-start justify-start w-auto md:w-full">
            <div className="flex flex-col gap-[18px] items-start justify-start w-auto">
              ...
              <div className="bg-white-A700 border border-gray-200_01 border-solid flex flex-col gap-[18px] h-[155px] md:h-auto items-start justify-start p-[18px] rounded-[10px] w-full">
                <Text
